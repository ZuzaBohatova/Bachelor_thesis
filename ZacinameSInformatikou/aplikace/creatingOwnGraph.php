...
<div id="creatingOwnGraph">
    <div id="infoText">
        ...
        <h4>Jak na to?</h4>
        <p>Graf nahráváme ve formátu <strong>.json</strong>. Vzorový .json obsahuje:</p>
        <p></p>
        <ul>
    ...
    <img id="jsonExample" src="../../pictures/graphs/json-example.png" alt="Příklad JSON" width="300" />
</div>